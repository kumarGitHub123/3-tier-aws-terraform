...
resource "aws_lb" "external-elb" {
  ...
  security_groups    = [aws_security_group.web-sg.id]
  subnets            = [aws_subnet.web-subnet[0].id, aws_subnet.web-subnet[1].id, aws_subnet.web-subnet[2].id]
}
...
resource "aws_db_subnet_group" "default" {
  name       = "main"
  subnet_ids = [aws_subnet.database-subnet[0].id, aws_subnet.database-subnet[1].id, aws_subnet.database-subnet[2].id]
